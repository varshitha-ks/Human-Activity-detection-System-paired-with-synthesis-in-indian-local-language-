...
from kannada import create_gui
...
class login_page:
    def __init__(self, root):
       ...
       # label1 = Label(self.frame1, text= "Human Activity", font=("times new roman", 20, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, text= "Human Activity Detection System", font=("times new roman", 20, "bold"), bg="yellow", fg="RoyalBlue1").place(x=20,y=300)
        label3 = Label(self.frame1, text= "It's all about Humans", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=130,y=360)
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost", user="user1", password="varshi@2024", database="student_database")
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Human Activity Detection System",parent=self.window)
                    create_gui()
